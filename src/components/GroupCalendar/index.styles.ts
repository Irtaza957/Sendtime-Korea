...
export const GroupCalendarSection = styled.section<{
  date: string;
  enableModal: boolean;
  selectable: boolean;
}>`
  ...
  .fc-col-header-cell.fc-day-disabled .fc-scrollgrid-sync-inner {
    background: inherit;
  }

  .fc-col-header-cell.fc-day-disabled .fc-scrollgrid-sync-inner:before {
    ${() => {
